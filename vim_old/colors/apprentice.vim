...
if ($TERM =~ '256' && &t_Co >= 256) || has("gui_running")
  ...
  hi Comment          ctermbg=NONE ctermfg=242  guibg=NONE    guifg=#6c6c6c cterm=NONE           gui=NONE
  ...
  hi Function         ctermbg=NONE ctermfg=131  guibg=NONE    guifg=#af5f5f cterm=NONE           gui=NONE
  ...
  hi SpellBad         ctermbg=NONE ctermfg=131  guibg=NONE    guifg=NONE    cterm=italic         gui=undercurl guisp=#af5f5f
...
elseif &t_Co == 8 || $TERM !~# '^linux' || &t_Co == 16
  ...
  hi Function         ctermbg=NONE        ctermfg=red         cterm=NONE
