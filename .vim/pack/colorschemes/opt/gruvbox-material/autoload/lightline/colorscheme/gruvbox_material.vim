...
elseif s:configuration.statusline_style ==# 'mix' "{{{
  ...
  let s:visual_r2_fg = s:palette.fg0
  let s:visual_r2_bg = s:palette.bg_statusline3
  let s:visual_middle_fg = s:palette.fg0
  ...
  let s:tab_l_fg = s:palette.fg0
  let s:tab_l_bg = s:palette.bg_statusline3
  let s:tab_r_fg = s:palette.bg0
  let s:tab_r_bg = s:palette.grey2
  let s:tab_sel_fg = s:palette.bg0
  let s:tab_sel_bg = s:palette.grey2
  let s:tab_middle_fg = s:palette.fg0
  ...
  let s:normal_l1_fg = s:palette.bg0
  let s:normal_l1_bg = s:palette.fg0
  let s:normal_l2_fg = s:palette.fg0
  let s:normal_l2_bg = s:palette.bg3
  let s:normal_r1_fg = s:palette.bg0
  let s:normal_r1_bg = s:palette.fg0
  let s:normal_r2_fg = s:palette.fg0
  let s:normal_r2_bg = s:palette.bg3
  let s:normal_middle_fg = s:palette.fg0
  let s:normal_middle_bg = s:palette.bg_statusline1

  let s:insert_l1_fg = s:palette.bg0
  let s:insert_l1_bg = s:palette.aqua
  let s:insert_l2_fg = s:palette.fg0
  let s:insert_l2_bg = s:palette.bg3
  let s:insert_r1_fg = s:palette.bg0
  let s:insert_r1_bg = s:palette.aqua
  let s:insert_r2_fg = s:palette.fg0
  ...
  let s:command_l1_fg = s:palette.bg0
  let s:command_l1_bg = s:palette.bg_green
  let s:command_l2_fg = s:palette.fg0
  let s:command_l2_bg = s:palette.bg3
  let s:command_r1_fg = s:palette.bg0
  let s:command_r1_bg = s:palette.bg_green
  let s:command_r2_fg = s:palette.fg0
