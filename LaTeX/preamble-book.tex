...
\usepackage{amsmath, amsfonts, amssymb, amstext, amscd, amsthm, arydshln, bbm, booktabs, CJKutf8, caption, chngcntr, color, colortbl, dsfont, enumerate, float, graphicx, hyperref, lipsum, listings, makecell, makeidx, mathrsfs, mathtools, marvosym, parskip, soul, stmaryrd, tikz, url, verbatim, xargs, xcolor, xfrac}
