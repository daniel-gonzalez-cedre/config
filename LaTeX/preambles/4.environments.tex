...
\ifminted
  \renewcommand{\theFancyVerbLine}{\normalfont\textcolor{foreground}{\tiny\arabic{FancyVerbLine}}}

  \newtcblisting{code}[2][]{
    autoparskip,
    listing engine=minted,
    % minted options app={escapeinside=??,mathescape,linenos,fontsize=\small},
    ...
    left=1pt, bottom=-2pt, top=-2pt, right=1pt,
    colupper=foreground, colback=background, colframe=foreground!10!background,
    valign=center,
    listing only,
    #1,
  }

  \newtcblisting{nocode}[2][]{
    autoparskip,
    listing engine=minted,
    % minted options app={escapeinside=??,mathescape,fontsize=\small},
    minted options app={escapeinside=??,mathescape,fontsize=\normalsize},
    minted style=gruvbox-light,
    minted language=#2,
    verbatim ignore indention at end=true,
    left=1pt, bottom=-2pt, top=-2pt, right=1pt,
  ...
  \newtcblisting{codedark}[2][]{
    ...
    verbatim ignore indention at end=true,
    left=1pt, bottom=-2pt, top=-2pt, right=1pt,
    colupper=cream!50!butter, colback=foreground, colframe=foreground,
    valign=center,
    listing only,
    #1,
  }
  ...
  \newtcblisting{codelight}[2][]{
    ...
    verbatim ignore indention at end=true,
    left=1pt, bottom=-2pt, top=-2pt, right=1pt,
    colupper=foreground, colback=cream!50!butter, colframe=cream!50!butter,
    valign=center,
    listing only,
    #1,
  }
  ...
  \NewTotalTCBox{\codeinline}{O{text} v}{
    ...
    before upper=\strut,
    left=2pt, bottom=2pt, top=0pt, right=2pt,
    colupper=foreground, colback=background, colframe=foreground!10!background,
  ...
  \NewTotalTCBox{\codeinlight}{O{text} v}{
    ...
    before upper=\strut,
    left=2pt, bottom=2pt, top=0pt, right=2pt,
    colupper=foreground, colframe=cream!50!butter, colback=cream!50!butter,
  }{\mintinline[escapeinside=??,mathescape,style=gruvbox-light,fontsize=\footnotesize]{#1}{#2}}
