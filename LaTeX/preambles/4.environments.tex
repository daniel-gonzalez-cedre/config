...
\ifminted
  ...
  \newtcblisting{codedark}[2][]{
    ...
    verbatim ignore indention at end=true,
    left=3pt, bottom=0pt, top=0pt, right=3pt,
    colupper=butter, colback=foreground, colframe=foreground,
    listing only,
    on line,
    #1,
  }
  ...
  \newtcblisting{codelight}[2][]{
    ...
    verbatim ignore indention at end=true,
    left=3pt, bottom=0pt, top=0pt, right=3pt,
    colupper=foreground, colback=butter, colframe=butter,
    listing only,
    on line,
    #1,
  }
  ...
  \NewTotalTCBox{\codeinlight}{O{text} v}{
    before upper=\strut,
    boxsep=0pt, left=3pt, bottom=0pt, top=0pt, right=3pt,
    colupper=foreground, colframe=butter, colback=butter,
    listing only,
    on line,
