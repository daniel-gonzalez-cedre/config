...
\ifminted
  ...
  \newtcblisting{codedark}[2][]{
    ...
    minted options app={mathescape,linenos,fontsize=\footnotesize},  
    % minted options app={mathescape,linenos,fontsize=\normalsize},
    minted options app={mathescape,linenos},  
  ...
  \NewTotalTCBox{\codeindark}{O{text} v}{
    ...
    listing only,
    on line,
  }{\mintinline[style=gruvbox-dark,fontsize=\footnotesize]{#1}{#2}}
  % }{\mintinline[style=gruvbox-dark,fontsize=\normalsize]{#1}{#2}}
  ...
  \NewTotalTCBox{\codeinlight}{O{text} v}{
    ...
    listing only,
    on line,
  }{\mintinline[style=gruvbox-light,fontsize=\footnotesize]{#1}{#2}}
  % }{\mintinline[style=gruvbox-light,fontsize=\normalsize]{#1}{#2}}
\else
\fi
