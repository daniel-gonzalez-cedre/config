...
\let\olddeg\deg
\let\deg\relax
% \DeclarePairedDelimiterX \deg[1]{\lvert}{\rvert}{\ifblank{#1}{\:\cdot\:}{#1}}
\DeclarePairedDelimiterXPP{\deg}[1]{\texttt{deg}}{(}{#1}{)}{}
\DeclarePairedDelimiterXPP{\degsub}[2]{\texttt{deg}_{#1}}{(}{#2}{)}{}
% \DeclarePairedDelimiterXPP{\degin}[2]{\mathbb{E}}  {[} {]} {#1}{#2}{}
