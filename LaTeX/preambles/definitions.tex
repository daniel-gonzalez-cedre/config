% BEGIN COLORS
  ...
  \definecolor{grey}{HTML}{746864}
  \definecolor{sepia}{HTML}{f7f0e4}  % f7f0e4 fdfbf8
  \definecolor{cream}{HTML}{fdfbf8}  % f7f0e4 fbf7f1 fdfbf8
  ...
  \newcommand{\rust}[1]{\textcolor{rust}{#1}}
  \newcommand{\orange}[1]{\textcolor{orange}{#1}}
  \newcommand{\red}[1]{\textcolor{red}{#1}}
  \newcommand{\purple}[1]{\textcolor{purple}{#1}}

  \newcommand{\tblack}[1]{\cellcolor{black}{\white{#1}}}
  \newcommand{\tbrown}[1]{\cellcolor{brown}{\white{#1}}}
  \newcommand{\tgrey}[1]{\cellcolor{grey}{\white{#1}}}
  \newcommand{\tcream}[1]{\cellcolor{cream}{\black{#1}}}
  \newcommand{\tsepia}[1]{\cellcolor{sepia}{\black{#1}}}
  \newcommand{\tblue}[1]{\cellcolor{blue}{\white{#1}}}
  \newcommand{\tgreen}[1]{\cellcolor{green}{\white{#1}}}
  \newcommand{\tyellow}[1]{\cellcolor{yellow}{\white{#1}}}
  \newcommand{\tgold}[1]{\cellcolor{gold}{\white{#1}}}
  \newcommand{\torange}[1]{\cellcolor{orange}{\white{#1}}}
  \newcommand{\tred}[1]{\cellcolor{red}{\white{#1}}}
  \newcommand{\tpurple}[1]{\cellcolor{purple}{\white{#1}}}
...
\newcommand{\power}[1]{\mathfrak{P}\pn*{#1}}
