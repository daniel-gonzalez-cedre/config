...
\newcommand{\bydefn}{\hspace{2pt}\mathrel{\vcentcolon\Leftrightarrow}\hspace{2pt}}
\newcommand{\iffbydefn}{\hspace{2pt}\mathrel{\vcentcolon\Leftrightarrow}\hspace{2pt}}
\newcommand{\defiff}{\hspace{2pt}\mathrel{\vcentcolon\Leftrightarrow}\hspace{2pt}}

\newcommand{\proves}{\hspace{2pt}\vdash\hspace{2pt}}
\newcommand{\satisfies}{\hspace{2pt}\models\hspace{2pt}}
% \renewcommand{\implies}{\hspace{1pt}\Rightarrow\hspace{1pt}}
\renewcommand{\implies}{\hspace{1pt}\mathrel{\Rightarrow}\hspace{1pt}}
% \renewcommand{\impliedby}{\hspace{1pt}\Leftarrow\hspace{1pt}}
\renewcommand{\impliedby}{\hspace{1pt}\mathrel{\Leftarrow}\hspace{1pt}}
% \renewcommand{\iff}{\hspace{1pt}\Leftrightarrow\hspace{1pt}}
\renewcommand{\iff}{\mathrel{\hspace{1pt}\Leftrightarrow}\hspace{1pt}}
\newcommand{\lequiv}{\mathrel{\hspace{1pt}\equiv\hspace{1pt}}}
% \newcommand{\isomorphic}{\hspace{1pt}\cong\hspace{1pt}}
\newcommand{\isomorphic}{\mathrel{\cong}}

\newcommand{\notproves}{\hspace{1pt}\nvdash\hspace{1pt}}
\newcommand{\notsatisfies}{\hspace{1pt}\not\models\hspace{1pt}}
\newcommand{\notlequiv}{\hspace{1pt}\not\equiv\hspace{1pt}}
\newcommand{\notimplies}{\hspace{1pt}\not\Rightarrow\hspace{1pt}}
\newcommand{\notimpliedby}{\hspace{1pt}\not\Leftarrow\hspace{1pt}}
\newcommand{\notiff}{\mathrel{{\ooalign{\hidewidth$\not\phantom{"}$\hidewidth\cr$\iff$}}}}
\newcommand{\notisomorphic}{\hspace{1pt}\not\cong\hspace{1pt}}
...
\newcommand{\Land}{\hspace{1pt}\wedge\hspace{1pt}}
\newcommand{\Lor}{\hspace{1pt}\vee\hspace{1pt}}
\newcommand{\Lif}{\hspace{1pt}\rightarrow\hspace{1pt}}
\newcommand{\Liff}{\hspace{1pt}\leftrightarrow\hspace{1pt}}
...
\newcommand{\suchthat}{\hspace{2pt}\vert\hspace{2pt}}
% \newcommand{\contradiction}{\smash{\textnormal{\raisebox{-0.25ex}{\Large \Lightning}}} }
% \newcommand{\contradiction}{\smash{\textnormal{\faBolt}}\hspace{1pt} }
\newcommand{\contradiction}{\smash{\textnormal{\Lightning}}\hspace{1pt} }

\newcommand{\mean}[1]{\overline{#1}}
\newcommand{\conjugate}[1]{\overline{#1}}
% \newcommand{\complement}[1]{\overline{#1}}  % already defined lol?

\newcommand*\diff{\mathop{}\hspace{-1pt}\mathrm{d}}
...
\newcommand{\substr}[2]{\text{\normalshape \tt [}\ifblank{#1}{\hspace{-1pt}}{#1}:\ifblank{#2}{\hspace{-1pt}}{#2}\text{\normalshape \tt ]}}
\newcommand{\slice}[2]{\text{\normalshape \tt [}\ifblank{#1}{\hspace{-1pt}}{#1}:\ifblank{#2}{\hspace{-1pt}}{#2}\text{\normalshape \tt ]}}

% \DeclarePairedDelimiterXPP{\slice}[2]{}{\texttt{[}}{\texttt{]}}{}{\ifblank{#1}{\hspace{-1pt}}{#1}\hspace{-1pt}:\hspace{-1pt}\ifblank{#2}{\hspace{-1pt}}{#2}}
...
\DeclareMathOperator*{\argmin}{arg\hspace{-1pt}\min}
\DeclareMathOperator*{\argmax}{arg\hspace{-1pt}\max}
...
\DeclarePairedDelimiterX \abs[1]{\lvert}{\rvert}{\ifblank{#1}{\hspace{2pt}\cdot\hspace{2pt}}{#1}}
\DeclarePairedDelimiterX \norm[1]{\lVert}{\rVert}{\ifblank{#1}{\hspace{2pt}\cdot\hspace{2pt}}{#1}}
\DeclarePairedDelimiterX \inner[2]{\langle}{\rangle}{\ifblank{#1}{\hspace{2pt}\cdot\hspace{2pt}}{#1},\ifblank{#2}{\hspace{2pt}\cdot\hspace{2pt}}{#2}}
\DeclarePairedDelimiterX \bracket[1]{\langle}{\rangle}{\ifblank{#1}{\hspace{2pt}\cdot\hspace{2pt}}{#1}}
\DeclarePairedDelimiterX \bra[1]{\langle}{\rvert}{\ifblank{#1}{\hspace{2pt}\cdot\hspace{2pt}}{#1}}
\DeclarePairedDelimiterX \ket[1]{\lvert}{\rangle}{\ifblank{#1}{\hspace{2pt}\cdot\hspace{2pt}}{#1}}
\DeclarePairedDelimiterX \floor[1]{\lfloor}{\rfloor}{\ifblank{#1}{\hspace{2pt}\cdot\hspace{2pt}}{#1}}
\DeclarePairedDelimiterX \ceil[1]{\lceil}{\rceil}{\ifblank{#1}{\hspace{2pt}\cdot\hspace{2pt}}{#1}}
\DeclarePairedDelimiterX \ceiling[1]{\lceil}{\rceil}{\ifblank{#1}{\hspace{2pt}\cdot\hspace{2pt}}{#1}}

\newcommand{\falling}[1]{^{\underline{\ifblank{#1}{\hspace{1pt}\cdot\hspace{-1pt}\hspace{2pt}}{#1}}}}
\newcommand{\rising}[1]{^{\overline{\ifblank{#1}{\hspace{1pt}\cdot\hspace{-1pt}\hspace{2pt}}{#1}}}}
...
\DeclarePairedDelimiterX \set[1]{\lbrace}{\rbrace}{%
  \renewcommand{\suchthat}{\hspace{2pt}\delimsize\vert\nonscript\hspace{2pt}\mathopen{}}%
  \renewcommand{\given}{\hspace{2pt}\delimsize\vert\nonscript\hspace{2pt}\mathopen{}}#1%
}
