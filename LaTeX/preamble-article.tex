...
\ifindenttheorems
    ...
    \newenvironment{theorem}[1][]
        {\begin{pretheorem}[#1]\quote~

            }
        {\endquote\end{pretheorem}}
    % lemma
    \newenvironment{lemma}[1][]
        {\begin{prelemma}[#1]\quote~

            }
        {\endquote\end{prelemma}}
    % proposition
    \newenvironment{proposition}[1][]
        {\begin{preproposition}[#1]\quote~

            }
        {\endquote\end{preproposition}}
    % corollary
    \newenvironment{corollary}[1][]
        {\begin{precorollary}[#1]\quote~

            }
        {\endquote\end{precorollary}}
    % claim
    \newenvironment{claim}[1][]
        {\begin{preclaim}[#1]\quote~

            }
        {\endquote\end{preclaim}}
    % conjecture
    \newenvironment{conjecture}[1][]
        {\begin{preconjecture}[#1]\quote~

            }
        {\endquote\end{preconjecture}}
    % justification
    \newenvironment{justification}[1][]
        {\begin{prejustification}[#1]\quote~
    ...
    \newenvironment{idea}[1][]
        {\begin{preidea}[#1]\quote~

            }
        {\endquote\end{preidea}}
    % remark
    \newenvironment{remark}[1][]
        {\begin{preremark}[#1]\quote~

            }
        {\endquote\end{preremark}}
    % note
    \newenvironment{note}[1][]
        {\begin{prenote}[#1]\quote~

            }
        {\endquote\end{prenote}}
\else
    \theoremstyle{thm}% style for theorems
