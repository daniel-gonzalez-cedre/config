...
% gruvbox colors
\definecolor{gred}{HTML}{CC214D}
\definecolor{gorange}{HTML}{D65D0E}
\definecolor{gaqua}{HTML}{689D6A}
\definecolor{gpurple}{HTML}{B16286}

% plotting colors
\definecolor{pblack}{HTML}{252422}
\definecolor{pgrey}{HTML}{f4efef}
\definecolor{pblue}{HTML}{045275}
\definecolor{pteal}{HTML}{089099}
\definecolor{pgreen}{HTML}{7ccba2}
\definecolor{pyellow}{HTML}{ffc61e}  % fcde9c % ffc61e  % b8860b
\definecolor{porange}{HTML}{f0746e}
\definecolor{pred}{HTML}{dc3977}
\definecolor{ppurple}{HTML}{7c1d6f}
