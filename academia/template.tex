...
\usepackage{amsmath, amsfonts, amssymb, amstext, amscd, amsthm, bbm, CJKutf8, caption, color, dsfont, enumerate, float, graphicx, hyperref, lipsum, listings, makeidx, mathrsfs, mathtools, marvosym, soul, stmaryrd, tikz, url, verbatim, xcolor, xfrac}
